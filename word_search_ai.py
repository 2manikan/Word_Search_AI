...
#word search 
graph = {1:['A',{2: 'right',4: 'down'}], 2:['T',{1: 'left',3: 'right',5: 'down'}],3:['R',{2: 'left',6: 'down'}],4:['T',{1: 'up',5: 'right'}],5:['T',{2: 'up',4: 'left',6: 'right'}],6:['T',{3: 'up',5: 'left'}], } #(id: [letter, neighbor_id_list])
word = "ATE"
